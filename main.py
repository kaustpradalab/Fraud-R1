...
from evaluation.AccidentCheck import AccidentCheck
...
def main():
    ...
    parser.add_argument("--checker", action="store_true", help="Help to check if analysis contains scam detection")
    ...
    if args.mode == "attack":
        ...
        if args.checker:
            checker = AccidentCheck(args.eval_input_folder)
            checker.process_checking()
